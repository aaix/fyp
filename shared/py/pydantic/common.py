...
def str_is_printable_no_whitespace_lower(string: str) -> str:
...
type Username = Annotated[str, AfterValidator(str_is_printable_no_whitespace_lower), Field(max_length=USERNAME_MAX_LENGTH, min_length=USERNAME_MIN_LENGTH)]
