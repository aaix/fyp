...
class CreateChannelRequest(_message.Message):
    __slots__ = ("channel_type", "opt_channel_name", "channel_icon_asset_id")
    CHANNEL_TYPE_FIELD_NUMBER: _ClassVar[int]
    OPT_CHANNEL_NAME_FIELD_NUMBER: _ClassVar[int]
    CHANNEL_ICON_ASSET_ID_FIELD_NUMBER: _ClassVar[int]
    channel_type: int
    opt_channel_name: str
    channel_icon_asset_id: _plib_pb2.pUUID
    def __init__(self, channel_type: _Optional[int] = ..., opt_channel_name: _Optional[str] = ..., channel_icon_asset_id: _Optional[_Union[_plib_pb2.pUUID, _Mapping]] = ...) -> None: ...

class UpdateChannelRequest(_message.Message):
    __slots__ = ("opt_channel_name", "channel_icon_asset_id")
    OPT_CHANNEL_NAME_FIELD_NUMBER: _ClassVar[int]
    CHANNEL_ICON_ASSET_ID_FIELD_NUMBER: _ClassVar[int]
    opt_channel_name: str
    channel_icon_asset_id: _plib_pb2.pUUID
    def __init__(self, opt_channel_name: _Optional[str] = ..., channel_icon_asset_id: _Optional[_Union[_plib_pb2.pUUID, _Mapping]] = ...) -> None: ...
...
class ChannelObjectResponse(_message.Message):
    __slots__ = ("channel_id", "channel_type", "opt_channel_name", "channel_members", "channel_icon_asset_id")
    CHANNEL_ID_FIELD_NUMBER: _ClassVar[int]
    CHANNEL_TYPE_FIELD_NUMBER: _ClassVar[int]
    OPT_CHANNEL_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    channel_icon_asset_id: _plib_pb2.pUUID
    def __init__(self, channel_id: _Optional[_Union[_plib_pb2.pUUID, _Mapping]] = ..., channel_type: _Optional[int] = ..., opt_channel_name: _Optional[str] = ..., channel_members: _Optional[_Iterable[_Union[_plib_pb2.pUUID, _Mapping]]] = ..., channel_icon_asset_id: _Optional[_Union[_plib_pb2.pUUID, _Mapping]] = ...) -> None: ...
...
class AddChannelMemberRequest(_message.Message):
    __slots__ = ("user_id", "channel_id", "encrypted_channel_key")
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    CHANNEL_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, user_id: _Optional[_Union[_plib_pb2.pUUID, _Mapping]] = ..., channel_id: _Optional[_Union[_plib_pb2.pUUID, _Mapping]] = ..., encrypted_channel_key: _Optional[bytes] = ...) -> None: ...
...
class AddChannelMembersRequest(_message.Message):
    ...
    def __init__(self, requests: _Optional[_Iterable[_Union[AddChannelMemberRequest, _Mapping]]] = ...) -> None: ...
