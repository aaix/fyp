...
if something does not look right, or you are going to have to make a "hacky" or indirect workaround, do NOT implement it, instead ask a question, mark it, use a placeholder, or suggest an alternative
